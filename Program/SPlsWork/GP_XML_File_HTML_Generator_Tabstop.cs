...
namespace UserModule_GP_XML_FILE_HTML_GENERATOR_TABSTOP
{
    public class UserModuleClass_GP_XML_FILE_HTML_GENERATOR_TABSTOP : SplusObject
    {
        ...
        private void FPARSE (  SplusExecutionContext __context__ ) 
            ...
            SDATA  = new CrestronString( Crestron.Logos.SplusObjects.CrestronStringEncoding.eEncodingASCII, 612, this );
            
            CrestronString SDATA2;
            SDATA2  = new CrestronString( Crestron.Logos.SplusObjects.CrestronStringEncoding.eEncodingASCII, 612, this );
            ...
            for( uint i = 0; i < 11; i++ )
                SFSP [i] = new CrestronString( Crestron.Logos.SplusObjects.CrestronStringEncoding.eEncodingASCII, 20, this );
            ...
            CrestronString [] STSS;
            STSS  = new CrestronString[ 11 ];
            for( uint i = 0; i < 11; i++ )
                STSS [i] = new CrestronString( Crestron.Logos.SplusObjects.CrestronStringEncoding.eEncodingASCII, 20, this );
            
            CrestronString [] STST;
            STST  = new CrestronString[ 11 ];
            for( uint i = 0; i < 11; i++ )
                STST [i] = new CrestronString( Crestron.Logos.SplusObjects.CrestronStringEncoding.eEncodingASCII, 20, this );
            
            CrestronString [] HTML_OBJECT_TEMP;
            HTML_OBJECT_TEMP  = new CrestronString[ 11 ];
            for( uint i = 0; i < 11; i++ )
                HTML_OBJECT_TEMP [i] = new CrestronString( Crestron.Logos.SplusObjects.CrestronStringEncoding.eEncodingASCII, 612, this );
            
            CrestronString HTML_TEMP_STR;
            HTML_TEMP_STR  = new CrestronString( Crestron.Logos.SplusObjects.CrestronStringEncoding.eEncodingASCII, 612, this );
            ...
            if ( Functions.TestForTrue  ( ( Functions.BoolToInt ( (Functions.TestForTrue ( Functions.Find( "</HTMLConfig>" , G_SFILE ) ) && Functions.TestForTrue ( Functions.Find( "<HTMLConfig>" , G_SFILE ) )) ))  ) ) 
                ...
                while ( Functions.TestForTrue  ( ( Functions.BoolToInt ( (Functions.TestForTrue ( Functions.BoolToInt ( (Functions.TestForTrue ( Functions.Find( "<Font " , G_SFILE ) ) || Functions.TestForTrue ( Functions.Find( "<CIPS " , G_SFILE ) )) ) ) || Functions.TestForTrue ( Functions.Find( "<Format " , G_SFILE ) )) ))  ) ) 
                    ...
                    if ( Functions.TestForTrue  ( ( Functions.BoolToInt ( (Functions.TestForTrue ( Functions.Find( "<obj>" , G_SFILE ) ) && Functions.TestForTrue ( Functions.Find( "</obj>" , G_SFILE ) )) ))  ) ) 
                        ...
                        if ( Functions.TestForTrue  ( ( Functions.Find( "<Tabstop " , SDATA2 ))  ) ) 
                            { 
                            __context__.SourceCodeLine = 174;
                            SDATA  .UpdateValue ( Functions.Remove ( "/>" , SDATA2 )  ) ; 
                            __context__.SourceCodeLine = 175;
                            STSS [ I ]  .UpdateValue ( FXML_ATTRIBUTE (  __context__ , SDATA, "Tabstop", "FTS")  ) ; 
                            __context__.SourceCodeLine = 176;
                            STST [ I ]  .UpdateValue ( FXML_ATTRIBUTE (  __context__ , SDATA, "Tabstop", "type")  ) ; 
                ...
                for ( J  = __FN_FORSTART_VAL__1; (__FN_FORSTEP_VAL__1 > 0)  ? ( (J  >= __FN_FORSTART_VAL__1) && (J  <= __FN_FOREND_VAL__1) ) : ( (J  <= __FN_FORSTART_VAL__1) && (J  >= __FN_FOREND_VAL__1) ) ; J  += (ushort)__FN_FORSTEP_VAL__1) 
                    ...
                    for ( K  = __FN_FORSTART_VAL__2; (__FN_FORSTEP_VAL__2 > 0)  ? ( (K  >= __FN_FORSTART_VAL__2) && (K  <= __FN_FOREND_VAL__2) ) : ( (K  <= __FN_FORSTART_VAL__2) && (K  >= __FN_FOREND_VAL__2) ) ; K  += (ushort)__FN_FORSTEP_VAL__2) 
                        ...
                        if ( Functions.TestForTrue  ( ( Functions.BoolToInt (Functions.Length( SCSJ[ K ] ) == 0))  ) ) 
                            ...
                            __context__.SourceCodeLine = 195;
                                ...
                                {
                                int __SPLS_TMPVAR__SWTCH_1__ = ((int)Functions.Atoi( STST[ K ] ));
                                
                                    { 
                                    if  ( Functions.TestForTrue  (  ( __SPLS_TMPVAR__SWTCH_1__ == ( 0) ) ) ) 
                                        { 
                                        __context__.SourceCodeLine = 199;
                                        HTML_OBJECT_TEMP [ K ]  .UpdateValue ( "<Font " + "size=" + "\u0022" + SFFS [ K ] + "\u0022" + " " + "face=" + "\u0022" + SFFF [ K ] + "\u0022" + " " + "color=" + "\u0022" + SFFC [ K ] + "\u0022" + ">" + SFSP [ K ] + SCAT [ K ] + SFFT [ K ] + "</FONT>"  ) ; 
                                        } 
                                    
                                    else if  ( Functions.TestForTrue  (  ( __SPLS_TMPVAR__SWTCH_1__ == ( 1) ) ) ) 
                                        { 
                                        __context__.SourceCodeLine = 204;
                                        HTML_OBJECT_TEMP [ K ]  .UpdateValue ( "<textformat tabstops='[" + STSS [ I ] + "]'>" + "<Font " + "size=" + "\u0022" + SFFS [ K ] + "\u0022" + " " + "face=" + "\u0022" + SFFF [ K ] + "\u0022" + " " + "color=" + "\u0022" + SFFC [ K ] + "\u0022" + ">" + SFSP [ K ] + SCAT [ K ] + SFFT [ K ] + "</FONT>" + "\u0009"  ) ; 
                                        } 
                                        ...
                                        HTML_OBJECT_TEMP [ K ]  .UpdateValue ( "<Font " + "size=" + "\u0022" + SFFS [ K ] + "\u0022" + " " + "face=" + "\u0022" + SFFF [ K ] + "\u0022" + " " + "color=" + "\u0022" + SFFC [ K ] + "\u0022" + ">" + SFSP [ K ] + SCAT [ K ] + SFFT [ K ] + "</FONT>" + "</textformat>"  ) ; 
                                        } 
                            ...
                            __context__.SourceCodeLine = 223;
                                ...
                                {
                                int __SPLS_TMPVAR__SWTCH_2__ = ((int)Functions.Atoi( STST[ K ] ));
                                    ...
                                    if  ( Functions.TestForTrue  (  ( __SPLS_TMPVAR__SWTCH_2__ == ( 0) ) ) ) 
                                        ...
                                        if ( Functions.TestForTrue  ( ( Functions.BoolToInt (Functions.Length( SCAT[ K ] ) == 0))  ) ) 
                                            ...
                                            HTML_OBJECT_TEMP [ K ]  .UpdateValue ( "<textformat tabstops='[" + STSS [ K ] + "]'>" + "<Font " + "size=" + "\u0022" + SFFS [ K ] + "\u0022" + " " + "face=" + "\u0022" + SFFF [ K ] + "\u0022" + " " + "color=" + "\u0022" + SFFC [ K ] + "\u0022" + ">" + SFSP [ K ] + "<cip" + Functions.Lower ( SCT [ K ] ) + ">" + SCT [ K ] + "$" + Functions.ItoA (  (int) ( (Functions.Atoi( SCSJ[ K ] ) + J) ) ) + "?" + SCDT [ K ] + "</cip" + Functions.Lower ( SCT [ K ] ) + ">" + SFFT [ K ] + "</FONT>" + "\u0009"  ) ; 
                                            } 
                                        
                                        else 
                                            { 
                                            __context__.SourceCodeLine = 250;
                                            HTML_OBJECT_TEMP [ K ]  .UpdateValue ( "<textformat tabstops='[" + STSS [ K ] + "]'>" + "<Font " + "size=" + "\u0022" + SFFS [ K ] + "\u0022" + " " + "face=" + "\u0022" + SFFF [ K ] + "\u0022" + " " + "color=" + "\u0022" + SFFC [ K ] + "\u0022" + ">" + SFSP [ K ] + "<cip" + Functions.Lower ( SCT [ K ] ) + ">" + SCT [ K ] + "$" + Functions.ItoA (  (int) ( (Functions.Atoi( SCSJ[ K ] ) + J) ) ) + "?" + SCDT [ K ] + "</cip" + Functions.Lower ( SCT [ K ] ) + ">" + SFFT [ K ] + "</FONT>" + "<Font " + "size=" + "\u0022" + SFFS [ K ] + "\u0022" + " " + "face=" + "\u0022" + SFFF [ K ] + "\u0022" + " " + "color=" + "\u0022" + SFFC [ K ] + "\u0022" + ">" + SCAT [ K ] + "<" + "</FONT>" + "\u0009"  ) ; 
                                            } 
                                        ...
                                        if ( Functions.TestForTrue  ( ( Functions.BoolToInt (Functions.Length( SCAT[ K ] ) == 0))  ) ) 
                                            ...
                                            HTML_OBJECT_TEMP [ K ]  .UpdateValue ( "<Font " + "size=" + "\u0022" + SFFS [ K ] + "\u0022" + " " + "face=" + "\u0022" + SFFF [ K ] + "\u0022" + " " + "color=" + "\u0022" + SFFC [ K ] + "\u0022" + ">" + SFSP [ K ] + "<cip" + Functions.Lower ( SCT [ K ] ) + ">" + SCT [ K ] + "$" + Functions.ItoA (  (int) ( (Functions.Atoi( SCSJ[ K ] ) + J) ) ) + "?" + SCDT [ K ] + "</cip" + Functions.Lower ( SCT [ K ] ) + ">" + SFFT [ K ] + "</FONT>" + "</textformat>"  ) ; 
                                            } 
                                        
                                        else 
                                            { 
                                            __context__.SourceCodeLine = 280;
                                            HTML_OBJECT_TEMP [ K ]  .UpdateValue ( "<Font " + "size=" + "\u0022" + SFFS [ K ] + "\u0022" + " " + "face=" + "\u0022" + SFFF [ K ] + "\u0022" + " " + "color=" + "\u0022" + SFFC [ K ] + "\u0022" + ">" + SFSP [ K ] + "<cip" + Functions.Lower ( SCT [ K ] ) + ">" + SCT [ K ] + "$" + Functions.ItoA (  (int) ( (Functions.Atoi( SCSJ[ K ] ) + J) ) ) + "?" + SCDT [ K ] + "</cip" + Functions.Lower ( SCT [ K ] ) + ">" + SFFT [ K ] + "</FONT>" + "<Font " + "size=" + "\u0022" + SFFS [ K ] + "\u0022" + " " + "face=" + "\u0022" + SFFF [ K ] + "\u0022" + " " + "color=" + "\u0022" + SFFC [ K ] + "\u0022" + ">" + SCAT [ K ] + "<" + "</FONT>" + "</textformat>"  ) ; 
                                            } 
                    ...
                    HTML_OBJECT_ID [ (J + 1)]  .UpdateValue ( "<P>" + HTML_TEMP_STR + "</P>"  ) ; 
...
public override void LogosSplusInitialize()
{
    ...
    G_SFILE  = new CrestronString( Crestron.Logos.SplusObjects.CrestronStringEncoding.eEncodingASCII, 22000, this );
...
public UserModuleClass_GP_XML_FILE_HTML_GENERATOR_TABSTOP ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
